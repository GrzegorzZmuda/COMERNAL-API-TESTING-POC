...
def test_POST_sensordata_response_code():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() ,headers=correct_header_1)
    assert response.status_code==201
@pytest.mark.run(order=1)
def test_POST_sensordata_response_code_without_date():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full_without_date() ,headers=correct_header_1)
    assert response.status_code==201
@pytest.mark.run(order=1)
def test_POST_sensordata_response_code_without_temperature():
    response = requests.post(BASE +"/sensordata",gen_sensordata_without_temperature() ,headers=correct_header_1)
    assert response.status_code==400
@pytest.mark.run(order=1)
def test_POST_sensordata_response_code_no_auth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() )
    assert response.status_code==401
@pytest.mark.run(order=1)
def test_POST_sensordata_response_code_unauth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() ,headers=incorrect_header_1)
    assert response.status_code==401
@pytest.mark.run(order=1)
def test_POST_sensordata_response_code_no_sensor():
    response = requests.post(BASE +"/sensordata",gen_sensordata_sensot_not_exist() ,headers=correct_header_1)
    assert response.status_code==404


@pytest.mark.run(order=1)
def test_POST_sensordata_response_content():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_without_date():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full_without_date() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_without_temperature():
    response = requests.post(BASE +"/sensordata",gen_sensordata_without_temperature() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_no_auth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() )
    assert  'text/html' in response.headers.get('content-type')
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_unauth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() ,headers=incorrect_header_1)
    assert  'text/html' in response.headers.get('content-type')
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_no_sensor():
    response = requests.post(BASE +"/sensordata",gen_sensordata_sensot_not_exist() ,headers=correct_header_1)
    assert  'application/json' in response.headers.get('content-type')


@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg():
...
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_without_date():
    ...
    assert response_content["sensor_id"] == a["sensor_id"]
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_without_temperature():
    response = requests.post(BASE +"/sensordata",gen_sensordata_without_temperature() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"]["temperature"]== "measured temperature is required"
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_no_auth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() )
    response_content = response.content.decode()
    assert response_content=="Unauthorised"
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_unauth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() ,headers=incorrect_header_1)
    response_content = response.content.decode()
    assert response_content=="Unauthorised"
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_no_sensor():
    response = requests.post(BASE +"/sensordata",gen_sensordata_sensot_not_exist() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
...
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_type():
    response = requests.post(BASE + "/sensordata", gen_sensordata_full(), headers=correct_header_1)
    response_content = json.loads(response.content.decode())
...
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_type_without_date():
    response = requests.post(BASE + "/sensordata", gen_sensordata_full_without_date(), headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert type(response_content["id"]) == int
    assert type(response_content["temperature"]) == int
    ...
    assert type(response_content["sensor_id"]) == int
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_type_without_temperature():
    response = requests.post(BASE +"/sensordata",gen_sensordata_without_temperature() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert type(response_content["message"]["temperature"])== str
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_type_no_auth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() )
    response_content = response.content.decode()
    assert type(response_content)==str
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_type_unauth():
    response = requests.post(BASE +"/sensordata",gen_sensordata_full() ,headers=incorrect_header_1)
    response_content = response.content.decode()
    assert type(response_content)==str
@pytest.mark.run(order=1)
def test_POST_sensordata_response_content_msg_type_no_sensor():
    response = requests.post(BASE +"/sensordata",gen_sensordata_sensot_not_exist() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert type(response_content["message"]) ==str

@pytest.mark.run(order=1)
def test_POST_sensordata_response_code_empty_temperature_field():
    ...
    assert response.status_code==400
@pytest.mark.run(order=1)
def test_POST_sensordata_response_msg_type_empty_temperature_field():
    correct_header_1_upg = {'Authorization': correct_header_1['Authorization'], 'Content-Type': 'application/json'}
    temp = str({'temperature': 37, 'sensor_id': 108}).replace("\'", "\"")
    reqstr = temp[0:15] + temp[18:]
