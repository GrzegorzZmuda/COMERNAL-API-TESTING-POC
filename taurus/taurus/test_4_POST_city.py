...
def test_POST_city_response_code():
    response = requests.post(BASE +"/city",gen_body_full() ,headers=correct_header_1)
    assert response.status_code==201
@pytest.mark.run(order=1)
def test_POST_city_response_code_no_cityname():
    response = requests.post(BASE +"/city",gen_body_inhabitants() ,headers=correct_header_1)
    assert response.status_code==400
@pytest.mark.run(order=1)
def test_POST_city_response_code_no_inhabitants():
    response = requests.post(BASE +"/city",gen_body_cityname() ,headers=correct_header_1)
    assert response.status_code==400
@pytest.mark.run(order=1)
def test_POST_city_response_code_empty_body():
    response = requests.post(BASE +"/city",gen_body_empty() ,headers=correct_header_1)
    assert response.status_code==400
@pytest.mark.run(order=1)
def test_POST_city_response_code_str_as_inhabitants():
    response = requests.post(BASE + "/city", gen_body_full_str_as_inhabitants(), headers=correct_header_1)
    assert response.status_code == 400

@pytest.mark.run(order=1)
def test_POST_city_response_content():
    response = requests.post(BASE +"/city",gen_body_full() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'
@pytest.mark.run(order=1)
def test_POST_city_response_content_no_cityname():
    response = requests.post(BASE +"/city",gen_body_inhabitants() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'
@pytest.mark.run(order=1)
def test_POST_city_response_content_no_inhabitants():
    response = requests.post(BASE +"/city",gen_body_cityname() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'
@pytest.mark.run(order=1)
def test_POST_city_response_content_empty_body():
    response = requests.post(BASE +"/city",gen_body_empty() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'
@pytest.mark.run(order=1)
def test_POST_city_response_content_str_as_inhabitants():
    response = requests.post(BASE +"/city",gen_body_full_str_as_inhabitants() ,headers=correct_header_1)
    assert response.headers.get('content-type') == 'application/json'

@pytest.mark.run(order=1)
def test_POST_city_response_inside_content():
...
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_no_cityname():
    response = requests.post(BASE +"/city",gen_body_inhabitants() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"] != None
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_no_inhabitants():
    response = requests.post(BASE +"/city",gen_body_cityname() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"] != None
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_empty_body():
    response = requests.post(BASE +"/city",gen_body_empty() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"] != None
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_str_as_inhabitants():
    response = requests.post(BASE +"/city",gen_body_full_str_as_inhabitants() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"] != None

@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_type_no_cityname():
    response = requests.post(BASE +"/city",gen_body_inhabitants() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert type(response_content["message"]["cityname"]) == str
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_type_no_inhabitants():
    response = requests.post(BASE +"/city",gen_body_cityname() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert type(response_content["message"]["inhabitants"]) == str
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_type_empty_body():
    response = requests.post(BASE +"/city",gen_body_empty() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert type(response_content["message"]["cityname"]) == str
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_type_str_as_inhabitants():
    response = requests.post(BASE +"/city",gen_body_full_str_as_inhabitants() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    print(response_content["message"])
    assert type(response_content["message"]["inhabitants"]) == str
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_no_cityname():
    response = requests.post(BASE +"/city",gen_body_inhabitants() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"]["cityname"] == "Name of the city is required"
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_no_inhabitants():
    response = requests.post(BASE +"/city",gen_body_cityname() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"]["inhabitants"] == "Number of inhabitants required"
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_empty_body():
    response = requests.post(BASE +"/city",gen_body_empty() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    assert response_content["message"]["cityname"] == "Name of the city is required"
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_str_as_inhabitants():
    response = requests.post(BASE +"/city",gen_body_full_str_as_inhabitants() ,headers=correct_header_1)
    response_content = json.loads(response.content.decode())
    print(response_content["message"])
    assert response_content["message"]["inhabitants"] == "Number of inhabitants required"
...
@pytest.mark.run(order=1)
def test_POST_city_response_inside_content_correct_message_type_empty_inhabitants_field():
...
@pytest.mark.run(order=1)
def test_POST_city_response_code_empty_inhabitants_field():
    correct_header_1_upg = {'Authorization': correct_header_1['Authorization'], 'Content-Type': 'application/json'}
